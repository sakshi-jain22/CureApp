...
%>
	...
	<center>
		<img src="img/udoctor.png" width="125" height="125">
		<h2>Update Doctor</h2>
		<hr/>
	</center>
	
	<div class="container-fluid">
	<form method="post" action="fetchDoctorServlet" name="docForm" novalidate>
		...
		<div class="form-group row">
			...
			<label for="specialization">Specialization : </label>
				<select name="specialization" class="custom-select custom-select-sm" ng-class="{'is-invalid':docForm.specialization.$invalid && docForm.specialization.$touched}"
				 ng-model="doctorData.specialization" required>
				...
				<div class="form-check form-check-inline" ng-repeat="qual in Doctor.qualifications">
					 <input class="form-check-input" type="radio" name="qualifications" ng-model="doctorData.qualifications"  value="{{qual}}"> 
		...
		ng-class="{'is-invalid':docForm.hpin.$invalid && docForm.hpin.$touched}" />
			...
			<div class="col-sm-1 icon">
				...
				<div class="row">
					<div class="col-sm-6">
				<button type="submit" ng-disabled="docForm.$invalid" class="btn btn-block btn-sm btn-success"> Update </button>
				</div>
				<div class="col-sm-6">
				<button type="button" class="btn btn-block btn-sm btn-danger" ng-click="reset()"> Reset </button>
				</div>
				</div>				
				</form>
				</div>
